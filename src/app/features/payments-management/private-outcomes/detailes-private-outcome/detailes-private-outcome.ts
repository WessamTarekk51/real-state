...
@Component({
  selector: 'app-detailes-private-outcome',
  imports: [Button],
  templateUrl: './detailes-private-outcome.html',
  styleUrl: './detailes-private-outcome.scss',
})
export class DetailesPrivateOutcome {

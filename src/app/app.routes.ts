...
export const routes: Routes = [
  ...
  { path: 'real-state-management', canActivate: [AuthGuard, PermissionGuard],data: { permissions: ['Permissions.Assets.View'] }, loadChildren: () => import('./features/real-state-management/real-state-management-module').then(m => m.RealStateManagementModule) },
  { path: 'customer-management', canActivate: [AuthGuard,PermissionGuard], loadChildren: () => import('./features/customer-management/customer-management-module').then(m => m.CustomerManagementModule) },
